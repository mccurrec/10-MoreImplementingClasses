...
class Line(object):
    ...
    def slope(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        slope_numerator = self.start.y - self.end.y
        slope_denominator = self.start.x - self.end.x
    ...
    def midpoint(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        point_x = (self.start.x +self.end.x) / 2
        point_y = (self.start.y + self.end.y) / 2
