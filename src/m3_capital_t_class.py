    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        h_rect_corner1 = rg.Point(intersection_center.x- (width / 2), intersection_center.y - (letter_thickness / 2))
        h_rect_corner2 = rg.Point(intersection_center.x + (width / 2), intersection_center.y + (letter_thickness / 2))
        v_rect_corner1 = rg.Point(intersection_center.x - (letter_thickness / 2), intersection_center.y -
                                  (letter_thickness / 2))
        v_rect_corner2 = rg.Point(intersection_center.x + (letter_thickness / 2), intersection_center.y -
                                  (letter_thickness / 2) + height)
        self.h_rect = rg.Rectangle(h_rect_corner1, h_rect_corner2)
        self.v_rect = rg.Rectangle(v_rect_corner1, v_rect_corner2)
    ...
    def clone(self):
        ...
        #######################################################################
        return rg.Rectangle(self.v_rect.corner_1, self.v_rect.corner_2), \
               rg.Rectangle(self.h_rect.corner_1, self.h_rect.corner_2)
